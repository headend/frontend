...
class Agent(models.Model):
    ...
    is_monitor = models.BooleanField(default=False, null=True)
    is_alarm = models.BooleanField(default=False, null=True)
    signal_monitor = models.BooleanField(default=False, null=True)
    video_monitor = models.BooleanField(default=False, null=True)
    audio_monitor = models.BooleanField(default=False, null=True)
    run_thread   = models.IntegerField(blank=True, null=True, default=1)
